...
import { getSocks, countRows, getHistory, getLocations, getOfficers } from './DB'
...
router.get("/locations", async (req, res) => {
    ...
    res.render("locations", { locations, pages, curr_page: page, pageName: 'locations' });
});
...
router.get("/history", async (req, res) => {
    ...
    res.render("history", { history, pages, curr_page: page, pageName: "history" });
});
...
router.get("/officers", async (req, res) => {
    ...
    res.render("officers", { officers, pages, curr_page: page, pageName: 'officers' });
});
